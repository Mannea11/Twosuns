...
public class HouseEvent extends Event implements Clickable {
    ...
    public HouseEvent(OrthographicCamera camera, int triggerTileX, int triggerTileY, MainCharWalking mainChar) {
        this.camera = camera;
        ...
        text = "An old skinny and famished couple greets you with a wary expression." +
                "\nWe're not sure what kind of people you are, one of them says, " +
                "\"\nBut if you're here to steal from us, we won't let you get away with it.\" " +
                "\nThe world has changed, and so have we... " +
                "\nWe're doing our best to survive here..\"";
